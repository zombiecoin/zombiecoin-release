...
uint256 hashGenesisBlock("0x788da661d02c4fe4d1957cd68d1ae5ecf81c3f5b65bfbce7e27882c69985c5e0");
...
{
    int64 nSubsidy = 102 * COIN;

	// Subsidy is cut in half every 800000 blocks, which will occur approximately every 4.5 years
    nSubsidy >>= (nHeight / 800000); // zombiecoin: 800k blocks in ~3.8 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 60 * 60; // Zombiecoin: 2 hour
static const int64 nTargetSpacing = 150; // Zombiecoin: 2.5 minute blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Zombiecoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Zombiecoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xac239b9ec49d5112e9af2cc7da575b8e171c91bd3073b097946507632de1a278");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Zombiecoin Build V.1.0 January 22, 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391754388; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4741161;
        ...
        assert(block.hashMerkleRoot == uint256("0x6aa2081f2ddb35195db1683f5bf15350c91d55aa5bec4c527a613ed5df70a992"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Zombiecoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
